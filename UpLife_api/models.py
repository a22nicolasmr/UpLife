...
class Usuarios(models.Model):
    ...
    def __str__(self):
        return f"nome={self.nome}, nome_usuario={self.nome_usuario}, email={self.email}, contraseña={self.contraseña}, imaxe_perfil={self.imaxe_perfil}, altura={self.altura}, peso={self.peso}, obxectivo={self.obxectivo}, actividade={self.actividade}, idade={self.idade}, calorias_diarias={self.calorias_diarias}, auga_diaria={self.auga_diaria}, modo_aplicacion={self.modo_aplicacion}"
